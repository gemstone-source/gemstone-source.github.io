...
I tested for `sql` injection but no luck then i decided to check for the information site provides and the first thing to check was the message with some sort of the name and version of this web [HttpFileServer 2.3](http://www.rejetto.com/hfs/) 
