...
These lines show that the `shedule` is controlled here and it hash access to the database, also the task is used to perform `HealthChecker` on a web browser.
